...
function spawnObstaclesTop() 
{
  if(World.frameCount % 60 === 0) {
    obstacleTop = createSprite(900,50,40,50);
...
{
      if(World.frameCount % 60 === 0) {
        obstacleBottom = createSprite(900,350,40,50);
 ...
 function Bar() 
 {
         if(World.frameCount % 60 === 0)
         {
           coin = createSprite(900,200,10,30);
...
function Score()
{
         if(balloon.isTouching(coinGroup,Hit))
         {
           score = score + 1;
